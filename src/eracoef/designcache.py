...
from .design import AWAY_SLOTS, HOME_SLOTS, SEASON_PHASES, TARGETS, DesignSpec, WindowData, _order_games, ps_key
...
def build_window_cached(seasons, cfg, phases=SEASON_PHASES, gt_weight=None, target="pts",
